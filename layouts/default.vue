      ...
      <div class="flex justify-between">
        <div class="flex space-x-4">
          ...
          <div>
            <nuxt-link to="/" class="flex items-center py-3 px-3 text-gray-700">
              <svg class="w-7 h-7 mr-1 text-green-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <div class="hidden md:flex items-center space-x-1">
          <div>
            ...
            <div class="user-menu hidden absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
              <!-- Active: "bg-gray-100", Not Active: "" -->
              <nuxt-link to="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Your Profile</nuxt-link>
              <nuxt-link to="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-1">Settings</nuxt-link>
              <nuxt-link to="#" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-2">Sign out</nuxt-link>
            </div>
          </div>
